...
This plugin uses Stripe API version  **2015-08-07** to create tokens and charge credit cards. For better visualization of how it looks & works check screenshots tab.
...
16. **This plugin collects usage statistics ONLY ONCE DURING INSTALL for research purpose on user experience only It will not be shared with anyone.**
