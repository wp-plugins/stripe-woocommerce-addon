...
This plugin uses Stripe API version  **2015-08-19** to create tokens and charge credit cards. For better visualization of how it looks & works check screenshots tab.
